...
from pokewatcher.data.constants import (
    ...
    VAR_PARTY_MON1_ATTACK,
    VAR_PARTY_MON1_DEFENSE,
    VAR_PARTY_MON1_SPEED,
    VAR_PARTY_MON1_SP_ATTACK,
    VAR_PARTY_MON1_SP_DEFENSE,
        ...
        'output': {
            'csv': {
                ...
                'labels': {
                    ...
                    VAR_PARTY_MON1_ATTACK: 'Attack',
                    VAR_PARTY_MON1_DEFENSE: 'Defense',
                    VAR_PARTY_MON1_SP_ATTACK: 'Sp. Attack',
                    VAR_PARTY_MON1_SP_DEFENSE: 'Sp. Defense',
                    VAR_PARTY_MON1_SPEED: 'Speed',
