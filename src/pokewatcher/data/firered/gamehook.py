...
import pokewatcher.data.firered.constants as firered
...
P_TRAINER_CLASS: Final[str] = 'battle.trainer.opponent'
P_TRAINER_NUMBER: Final[str] = 'battle.trainer.opponentId'
P_BATTLE_OUTCOME: Final[str] = 'battle.outcome'
...
PROPERTIES: Final[Mapping[str, Mapping[str, Any]]] = {
    P_PLAYER_NAME: {
        'type': 'string',
        'label': firered.WRAM_PLAYER_NAME,
        'store': game_data.VAR_PLAYER_NAME,
    },
    P_TEAM_COUNT: {
        'type': 'int',
        'label': firered.WRAM_TEAM_COUNT,
    },
    P_GAME_TIME_HOURS: {
        'type': 'int',
        'bytes': True,
